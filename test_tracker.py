...
import yaml
import random
from ....FEAR.FEARTracker.model_training.tracker.fear_tracker import FEARTracker as F
from ....FEAR.FEARTracker.model_training.tracker import fear_tracker as f
from ....FEAR.FEARTracker.demo_video import get_tracker, track
    ...
    for video_key in video_keys:
        ...
        for i,image_file in enumerate(image_files):
            if 0==i:
                ...
                initial_bbox = np.array([163, 53, 45, 174])
                # assert False, 'process the initial frame here'
                regions.append(initial_bbox)
                ...
                location = track(tracker,image_file,initial_bbox)
